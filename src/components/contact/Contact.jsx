...
const Contact = () => {
    ...
    const sendEmail = (e) => {
      ...
      emailjs.sendForm('service_30uh3we', 'template_8r7ryfj', form.current, 'btfac_0jP685QYwvL')
        e.target.reset()
    };  
                ...
                <div className="contact_content">
                    ...
                    <div className="contact_info">
                        ...
                        <div className="contact_card">
                            ...
                            <a href="https://twitter.com/MoongaDez" className="contact_button">
                                DM on Twitter 
                                <i className="bx bx-right-arrow-alt contact_button-icon"></i>
                            </a>
                ...
                <div className="contact_content">
                    ...
                    <form ref={form} onSubmit={sendEmail} className="contact_form">
                        ...
                        <div className="contact_form-div">
                            ...
                            <input type="email" className="contact_form-input" name="email" placeholder="Insert your Email Address" />
                        </div>

                        <div className="contact_form-div contact_form-area">
                            <label className="contact_form-tag">Your Message</label>
                            <textarea className="contact_form-input" name="message" placeholder="Write your message" rows="10" cols="30"></textarea>
                        </div>
